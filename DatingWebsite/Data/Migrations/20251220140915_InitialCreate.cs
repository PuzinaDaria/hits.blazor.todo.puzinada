        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredAgeRange = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "Развлечения", "Кино" },
                    { 2, "Развлечения", "Музыка" },
                    { 3, "Образование", "Книги" },
                    { 4, "Активный отдых", "Спорт" },
                    { 5, "Отдых", "Путешествия" },
                    { 6, "Творчество", "Фотография" },
                    { 7, "Дом", "Кулинария" },
                    { 8, "IT", "Программирование" },
                    { 9, "Развлечения", "Игры" },
                    { 10, "Творчество", "Танцы" },
                    { 11, "Хобби", "Животные" },
                    { 12, "Образование", "Наука" },
                    { 13, "Творчество", "Искусство" },
                    { 14, "Стиль", "Мода" },
                    { 15, "Техника", "Автомобили" }
                });
